#' Job 01: N={20,50,100,200}, delta=0, all NLP orders
#'
...
bf_interval_path <- paste0("results/simulated/results_sim3_rstan_bf_interval_", job_tag, ".csv")
bf_bridge_path   <- paste0("results/simulated/results_sim3_rstan_bf_bridge_",   job_tag, ".csv")
posterior_path   <- paste0("results/simulated/results_sim3_rstan_posterior_draws_", job_tag, ".csv")
summary_path     <- paste0("results/simulated/results_sim3_rstan_bf_summary_",  job_tag, ".csv")
completed_path   <- paste0("results/simulated/results_sim3_rstan_completed_",   job_tag, ".csv")
...
for (delta in target_delta) {
  ...
  # Always use all_sample_sizes to build idx_list so subsets are identical
  # to those produced by the full simulation (03_interval_bf_nonlocal_prior.R)
