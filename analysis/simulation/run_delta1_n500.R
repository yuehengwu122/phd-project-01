...
message("Running delta-specific script: delta=1, N=500")
...
bf_interval_path <- "data/simulated/results_sim3_rstan_bf_interval_n500_d1.csv"
bf_bridge_path <- "data/simulated/results_sim3_rstan_bf_bridge_n500_d1.csv"
posterior_path <- "data/simulated/results_sim3_rstan_posterior_draws_n500_d1.csv"
summary_path <- "data/simulated/results_sim3_rstan_bf_summary_n500_d1.csv"
completed_path <- "data/simulated/results_sim3_rstan_completed_configs_n500_d1.csv"
