...
message("Running delta-specific script: delta=0")
...
bf_interval_path <- "data/simulated/results_sim3_rstan_bf_interval_d0.csv"
bf_bridge_path <- "data/simulated/results_sim3_rstan_bf_bridge_d0.csv"
posterior_path <- "data/simulated/results_sim3_rstan_posterior_draws_d0.csv"
summary_path <- "data/simulated/results_sim3_rstan_bf_summary_d0.csv"
completed_path <- "data/simulated/results_sim3_rstan_completed_configs_d0.csv"
