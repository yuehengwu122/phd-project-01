...
bf_interval_path <- "data/simulated/results_sim3_rstan_bf_interval.csv"
bf_bridge_path <- "data/simulated/results_sim3_rstan_bf_bridge.csv"
posterior_path <- "data/simulated/results_sim3_rstan_posterior_draws.csv"
summary_path <- "data/simulated/results_sim3_rstan_bf_summary.csv"
completed_path <- "data/simulated/results_sim3_rstan_completed_configs.csv"
...
# Per-script settings for multi-job run
cpu_available <- parallel::detectCores(logical = TRUE)

# choose how many scripts you run in parallel
n_jobs <- 8L

# reserve some cores for OS / overhead
reserve_cores <- 4L
