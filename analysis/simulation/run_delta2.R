...
message("Running delta-specific script: delta=2")
...
bf_interval_path <- "data/simulated/results_sim3_rstan_bf_interval_d2.csv"
bf_bridge_path <- "data/simulated/results_sim3_rstan_bf_bridge_d2.csv"
posterior_path <- "data/simulated/results_sim3_rstan_posterior_draws_d2.csv"
summary_path <- "data/simulated/results_sim3_rstan_bf_summary_d2.csv"
completed_path <- "data/simulated/results_sim3_rstan_completed_configs_d2.csv"
