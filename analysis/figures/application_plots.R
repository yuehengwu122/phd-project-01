...
plot_effect_posterior <- function(result, effect_type, sdr_values, title = NULL, 
                                  ylab = NULL, ylim = NULL) {
  ...
  if (is.null(title)) {
    title <- if (effect_type == "nonlinear") {
      expression(paste("Posterior Samples of ", delta[j], " (Nonlinear Effect)"))
    } else {
...
png("analysis/figures/output/delta_posterior_a3_nonlinear.png", 
...
png("analysis/figures/output/delta_posterior_a3_linear.png", 
    width = 7, height = 6, units = "in", res = 300)
plot_effect_posterior(
  fit_a3_dep, 
  effect_type = "linear", 
...
png("analysis/figures/output/delta_posterior_a4_nonlinear.png", 
...
png("analysis/figures/output/delta_posterior_a4_linear.png", 
    width = 9, height = 7, units = "in", res = 300)
plot_effect_posterior(
  fit_a4_dep, 
  effect_type = "linear", 
