...
plot_experiment1_by_N <- function(data_path = "data/simulated/results_sim1_251025.csv", 
                                  output_path = NULL) {
  ...
  df <- df %>%
    mutate(
      prior = factor(prior, levels = c(1, 2), 
  ...
  # Common aesthetics
  aes_common <- aes(x = delta, color = N, linetype = prior,
  ...
  p_bf <- ggplot(summary_df, aes_common) +
    ...
    scale_color_manual(values = c("30" = "red", "100" = "darkgreen", "200" = "blue")) +
    scale_linetype_manual(values = c("Horseshoe" = "solid", "Nonlocal" = "dashed"),
...
# output_path: Optional path to save the plot
# Returns: Combined ggplot object
plot_experiment2_by_lambda <- function(data_path1 = "data/simulated/results_sim1_251025.csv",
  ...
  # Common aesthetics
  aes_common <- aes(x = delta, color = lambda, linetype = prior,
  ...
  p_bf <- ggplot(summary_df, aes_common) +
    ...
    scale_color_manual(values = c("0.15" = "red", "0.33" = "darkgreen", "0.7" = "blue"),
...
plot1 <- plot_experiment1_by_N("data/simulated/results_sim1_251025.csv", "analysis/figures/output/plot-sim-1.png")
# print(plot1)

# # Example usage for Experiment 2:
plot2 <- plot_experiment2_by_lambda("data/simulated/results_sim1_251025.csv", "data/simulated/results_sim2_251108.csv", "analysis/figures/output/plot-sim-2.png")
# print(plot2)
