...
parameters {
  ...
  real<lower=0> delta;         // standardized GP amplitude
...
transformed parameters {
  real<lower=0> alpha = delta * sigma;
...
generated quantities {
...

  {
    ...
    matrix[N,N] K = gp_exp_quad_cov(x_c, delta * sigma, lambda);
    for (n in 1:N) K[n,n] += 1e-12;
